...
def test_build_escalator_runs_on_advisor_route_and_returns_result(monkeypatch):
    ...
    import veles.runtime.assembly as assembly
    ...
    monkeypatch.setattr(assembly, "_build_run_system_prompt", lambda a, p: "")
...
def test_emit_output_false_suppresses_print(capsys):
    from veles.runtime.assembly import _run_agent_streaming_aware
