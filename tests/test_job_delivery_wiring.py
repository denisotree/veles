...
# ---- M273: what a job delivers is recorded in the chat's session ----
...
class _JobAgent:
    ...
    def run(self, prompt: str):
        return type("R", (), {"text": self._text, "iterations": 1})()
...
async def test_a_delivered_job_is_in_the_chat_session(tmp_path: Path) -> None:
