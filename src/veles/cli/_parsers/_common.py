...
# The defaults live in veles.core.defaults so the runtime and the daemon can read
# them without importing the CLI; the argparse wiring below uses them.
from veles.core.defaults import (
