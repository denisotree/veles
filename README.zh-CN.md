...
**模块化，而非单体**——核心极小（内存、智能体循环、提供商协议、工具注册表）。其他一切——守护进程、Telegram 网关、深度研究、作业调度器——都是可选的、可加载的模块。
...
| `veles goal {list,show,start,pause,resume,cancel}` | 长周期目标 |
