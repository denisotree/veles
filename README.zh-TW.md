...
**模組化，而非單體式**——精簡的核心（記憶、代理迴圈、供應商協定、工具登錄）。其他所有東西——常駐程式、Telegram 閘道、深度研究、工作排程器——都是可選的、可載入的模組。
...
| `veles goal {list,show,start,pause,resume,cancel}` | 長時程目標 |
