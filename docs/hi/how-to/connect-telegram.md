...
`/goal <काम>` चैट में ही एक goal चलाता है। एजेंट जो जानना ज़रूरी है वह पूछता है
और वह योजना दिखाता है जिस पर चलेगा। आपके `yes` कहने पर वह ख़ुद काम करता है और हर
चरण के बाद एक पंक्ति भेजता है, जब तक goal पूरा न हो या बजट ख़त्म न हो। मंज़ूरी के
अनुरोध पहले की तरह बटन के रूप में आते हैं। `/goal` प्रगति दिखाता है,
`/goal cancel` मौजूदा चरण के बाद रोकता है और `/goal resume` रुके हुए goal को
जारी रखता है।
