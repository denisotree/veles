...
```toml
[memory]
turn_retention_days = 90   # 0 यानी सब कुछ हमेशा के लिए
```

कच्चे संवाद-टर्न इतने दिनों बाद हटा दिए जाते हैं; पर उनसे निकाले गए **इनसाइट्स** और
नियम हमेशा के लिए रखे जाते हैं। रिकॉर्ड कच्चा माल है और इनसाइट्स वह वजह जिसके लिए उसे
पढ़ा गया — इसलिए `memory.db` बेतहाशा बढ़ना बंद कर देता है, जबकि एजेंट का सीखा हुआ बना
रहता है।
...
दिखने वाली कीमत: `veles sessions search` सिर्फ़ विंडो के भीतर का टेक्स्ट ढूँढ पाता है।
`veles sessions list` पुराने रन फिर भी दिखाता रहता है, क्योंकि सत्र की पंक्तियाँ (id,
शीर्षक, टाइमस्टैम्प) बनी रहती हैं — सिर्फ़ संदेशों का मूल पाठ जाता है। सफ़ाई
