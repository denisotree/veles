...
| Variable | Propósito |
|---|---|
| `VELES_BUNDLE_VERSION` | Interno; no deberías necesitar configurarlo |
| `VELES_REPL_SIMPLE` | Ponlo a `1` para forzar el bucle REPL simple basado en líneas en lugar de la aplicación `prompt_toolkit` a pantalla completa (respaldo para terminales limitados) |
