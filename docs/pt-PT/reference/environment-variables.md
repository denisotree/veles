...
> 🌐 **Idiomas:** [English](../../en/reference/environment-variables.md) · [简体中文](../../zh-CN/reference/environment-variables.md) · [繁體中文](../../zh-TW/reference/environment-variables.md) · [日本語](../../ja/reference/environment-variables.md) · [한국어](../../ko/reference/environment-variables.md) · [Español](../../es/reference/environment-variables.md) · [Français](../../fr/reference/environment-variables.md) · [Italiano](../../it/reference/environment-variables.md) · [Português (BR)](../../pt-BR/reference/environment-variables.md) · **Português (PT)** · [Русский](../../ru/reference/environment-variables.md) · [العربية](../../ar/reference/environment-variables.md) · [हिन्दी](../../hi/reference/environment-variables.md) · [বাংলা](../../bn/reference/environment-variables.md) · [Tiếng Việt](../../vi/reference/environment-variables.md)
...
`VELES_LOCAL_JSON_MODE` abrange apenas as chamadas que o Veles sabe esperarem JSON estrito:
hoje é o advisor (usado por `advisor_review`, pelo passo de verify e pela fase CHECK do modo
goal). Os turnos normais do agente nunca o recebem: o caminho fenced-tools precisa de prosa à
volta dos seus blocos, e a restrição de objeto JSON proibi-la-ia. Também se auto-repara — um
backend que rejeite o parâmetro desativa-o para o resto do processo e o pedido é repetido sem
ele, pelo que normalmente não é preciso mexer neste interruptor.
...
| Variável | Finalidade |
|---|---|
| `VELES_BUNDLE_VERSION` | Interna; não deve precisar de a definir |
| `VELES_REPL_SIMPLE` | Definir como `1` para forçar o ciclo de REPL simples baseado em linhas em vez da app `prompt_toolkit` de ecrã inteiro (recurso de reserva para terminais limitados) |
