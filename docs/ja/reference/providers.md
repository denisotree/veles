...
> 🌐 **言語:** [English](../../en/reference/providers.md) · [Русский](../../ru/reference/providers.md) · **日本語**
...
デフォルト: プロバイダー `openrouter`、モデル `anthropic/claude-sonnet-4.6`、圧縮用 `anthropic/claude-haiku-4.5`。
