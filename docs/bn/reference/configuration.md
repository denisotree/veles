...
**আপনি না বললে কিছুই মোছা হয় না।** `turn_retention_days`-এর ডিফল্ট `0`, অর্থাৎ
সব কথোপকথনের টার্ন চিরকাল রাখা হয়। `memory.db`-তে সীমা বসাতে চাইলে দিনের সংখ্যা
দিন:

```toml
[memory]
turn_retention_days = 90   # 0 (ডিফল্ট) সবকিছু রাখে
```

চালু করলে তত দিনের চেয়ে পুরোনো কাঁচা টার্নগুলো মুছে ফেলা হয়; আর সেগুলো থেকে বের করা
**ইনসাইট** ও নিয়ম যেকোনো অবস্থাতেই চিরকাল রাখা হয়। রেকর্ড হলো কাঁচামাল, আর ইনসাইটই
সেই উদ্দেশ্য যার জন্য তা পড়া হয়েছিল।
...
চালু করার মূল্য: `veles sessions search` কেবল উইন্ডোর ভিতরের লেখা খুঁজে পায়।
