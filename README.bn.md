...
**মডিউলার, মনোলিথিক নয়** — ন্যূনতম কোর (মেমরি, এজেন্ট লুপ, প্রোভাইডার প্রোটোকল, টুল রেজিস্ট্রি)। বাকি সবকিছু — ডেমন, Telegram গেটওয়ে, গভীর গবেষণা, জব শিডিউলার — একটি ঐচ্ছিক, লোডযোগ্য মডিউল।
...
| `Ctrl+X Ctrl+E` | বর্তমান খসড়ায় `$EDITOR` খুলুন |
